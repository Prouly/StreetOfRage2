...
public class PlayerController_IPickable : MonoBehaviour
{
    [SerializeField] private InventoryPicker _inventory;
    ...
    // Detect Trigger collision with the ground to set the player as grounded
    private void OnTriggerEnter2D(Collider2D other)
    {
        ...
        if (other.CompareTag("Pickup"))
        {
            ...
            _inventory = GameManager.Instance.GetInventoryPicker();
